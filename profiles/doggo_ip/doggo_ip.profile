...
/**
 * @file
 * Enables modules and site configuration for a doggo_ip site installation.
 */
...
function doggo_ip_form_install_configure_form_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['#submit'][] = 'doggo_ip_form_install_configure_submit';
}

/**
 * Submission handler to sync the contact.form.feedback recipient.
 */
function doggo_ip_form_install_configure_submit($form, FormStateInterface $form_state) {
